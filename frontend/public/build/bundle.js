...
var app = (function () {
    ...
    function dollarAmountToInt(amount){
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 18, 4, 488);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	ring = new Ring({
    			props: {
    				size: "120",
    				value_of_total: "1292",
    				value_of_current: dollarAmountToInt(/*user_data*/ ctx[0].balances["Residence Meal Plan"])
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-wrhvgq");
    			add_location(h1, file$1, 10, 8, 206);
    			add_location(header, file$1, 9, 4, 188);
    			attr_dev(section, "class", "container svelte-wrhvgq");
    			add_location(section, file$1, 12, 4, 239);
    			attr_dev(main, "class", "svelte-wrhvgq");
    			add_location(main, file$1, 8, 0, 176);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    		...
    		p: function update(ctx, dirty) {
    			const ring_changes = {};
    			if (dirty & /*user_data*/ 1) ring_changes.value_of_current = dollarAmountToInt(/*user_data*/ ctx[0].balances["Residence Meal Plan"]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(8:0) {#if user_data.balances}",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Ring, dollarAmountToInt, user_data });
